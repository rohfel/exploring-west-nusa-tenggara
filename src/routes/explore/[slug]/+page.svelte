...
>
  ...
  <div
    class="mt-5 prose prose-h1:font-semibold prose-h2:font-medium prose-h3:font-normal prose-h4:font-normal prose-p:text-justify dark:prose-invert min-w-fit"
  >
